import { Calendar, User, Users, Package, LayoutDashboard, Settings, BookOpen, CreditCard, Home, Video, Activity } from 'lucide-react';
...
export const NAV_LINKS = {
    CUSTOMER: [
        ...
        { label: 'Gelişim', href: '/dashboard/measurements', icon: Activity },
